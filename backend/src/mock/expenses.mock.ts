...
export const EXPENSES_MOCK: Expense[] = [
  {
    ...
    purposeOfVisit: 'Initial site visit for 5-unit hardware integration',
  ...
  },
  {
    ...
    toLocation: 'RS Puram',
    purposeOfVisit: 'Customer meeting for commercial integration project',
    receiptUrl: undefined,
    paymentMode: 'UPI',
  ...
  },
  {
    ...
    toLocation: 'Trichy',
    purposeOfVisit: 'Site visit for system installation',
    receiptUrl: undefined,
    paymentMode: 'Cash',
